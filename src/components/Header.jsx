...
import Listnav from "./ListNavbar";
  ...
  return (
    <header className="py-3 border-b-1 border-b-[#1F1F1F] text-white fixed top-0 right-0 left-0 z-50 max-w-[1280px] w-full mx-auto bg-[#E5E7EB] dark:bg-[#0D0D0D] lg:h-18 h:14 sm:h-16">
      <div className="max-w-[1280px] w-full mx-auto px-6 lg:px-25 flex justify-between items-center h-full">
        <div>
          <h1
            className={`text-black font-semibold text-base md:text-2xl sm:text-lg dark:text-white`}
          >
        ...
        <div
          ...
          className={`flex flex-col h-7 justify-between mt-1 p-1 cursor-pointer container-span1 ${
            hamburgerAnimation ? "" : "container-span2"
        ...
        >
          <div className="flex flex-col h-full justify-around lg:px-15">
            <nav>
              <ul className="flex gap-6 lg:gap-3 flex-col">
                {navItems.map((item, index) => (
                  <Listnav
                    text={item.text}
                    href={item.href}
                    handleClick={hrefClick}
                    key={index}
                  />
                ))}
              </ul>
            ...
            <div>
              ...
              <div className="mt-4 flex gap-15 flex-wrap">
                ...
                <a
                  href="https://www.instagram.com/abdi.frdn"
                  target="_blank"
                  className="flex items-center gap-2 cursor-pointer"
                >
                  <div className="w-8">
