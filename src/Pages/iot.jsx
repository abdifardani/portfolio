...
const Iot = () => {
  return (
   <section className=" bg-[#0f0f0f] pt-30 px-6 pb-25 h-screen relative" id="Project">
        <div>
            <h1 className="text-center text-white font-medium tracking-[1px] text-xl">SELECTED IOT PROJECT</h1>
            <p className="text-center font-light mt-1 text-white">Here's All Of My IOT Project</p>
